...
const points = [
  ...
  },
  {
    title: 'Cash For Cars',
    description:
      'Selling your car with Asis Motors is fast because we can pay cash on the spot with one simple phone call.'
  }
];
  ...
  <section className="sell-info section" id="how-it-works">
    <div className="container sell-info__inner">
      <div className="sell-info__highlight">
        ...
        <p className="sell-info__tagline">Asis Motors is the fastest way to sell your car anywhere.</p>
