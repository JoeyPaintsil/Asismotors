...
const storyPanels = [
  {
    ...
    text: 'We launched Asis Motors from a single driveway in Cumming, GA helping neighbors sell cars the same day. Word spread because we show up when we say we will, keep every promise in writing, and treat every pickup like helping a friend.',
  ...
  },
  {
    ...
    text: 'Every Asis Motors buyer is background-checked and trained to handle paperwork, titles, and even tricky DMV scenarios. We tow for free, pay on the spot, and update you by text the whole way.',
    ...
    <main className="about">
      <section className="about__hero">
        <div className="container about__hero-inner">
          <div>
            <p className="eyebrow">About Asis Motors</p>
            <h1>We help drivers move on faster.</h1>
            <p>
              Asis Motors is a team of car buyers, pricing analysts, and support specialists obsessed with making it easy
          ...
          <img
            ...
            alt="Asis Motors team celebrating"
          />
        </div>
      </section>
