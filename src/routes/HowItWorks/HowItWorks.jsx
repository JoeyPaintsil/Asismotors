...
const journeySections = [
  ...
  },
  {
    ...
    text: 'Pick a time that works—even same day. A verified As-is Motor field agent meets you anywhere (home, office, storage) with paperwork in hand and free towing already included.',
    image: 'schedule_meeting.jpg'
  },
  {
    title: 'Hand off keys, get paid instantly',
    text: 'We pay by cash or check at pickup time. All payments are fully backed and guaranteed.',
    ...
    <main className="how">
      <section className="how__hero">
        <div className="container how__hero-inner">
          <div>
            <p className="eyebrow">How As-is Motor Works</p>
            <h1>Instant offers. Doorstep pickup. Cash before the tow truck leaves.</h1>
            <p>
              Skip listings and strangers. As-is Motor pairs smart pricing tech with real humans who pick up your car,
      ...
      <section className="how__perks section">
        <div className="container how__perks-inner">
          <div>
            <h2>Why drivers trust As-is Motor</h2>
